...
public class Television {
  ...
  private final Tuner tuner = new Tuner(); //Television HAS-A tuner for all tasks related to channel changing NOT exposed
  ...
  public void setBrand(String brand) {
    if (isValidBrand(brand)) {
      ...
      System.out.println(
          "Invalid brand: " + brand + " value of valid brands is " + Arrays.toString(VALID_BRANDS));
...
//                ", volume=" + volumeString + '}' +
//                " display=" + getDisplay() + '}';
    return String.format("Television: brand = %s, volume = %d display = %s, my channel is %s!",
